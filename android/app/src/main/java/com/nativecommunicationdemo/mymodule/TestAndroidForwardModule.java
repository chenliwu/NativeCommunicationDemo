...
import com.nativecommunicationdemo.TestFaceDetectionActivity;

/**
 * 测试RN与Android原生页面跳转
 */
public class TestAndroidForwardModule extends ReactContextBaseJavaModule {

    private ReactApplicationContext mReactContext;

    public TestAndroidForwardModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void startActivity() {
        try {
            ...
            if (currentActivity != null) {
                Intent intent = new Intent(currentActivity, TestFaceDetectionActivity.class);
